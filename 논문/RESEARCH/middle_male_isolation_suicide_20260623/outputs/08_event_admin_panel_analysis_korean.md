...
| region | 2020 | 2024 | expected_2024_if_national_growth | excess_2024_vs_expected | trajectory_type |
| --- | --- | --- | --- | --- | --- |
| 서울 | 571 | 784 | 683.32 | 100.68 | large_base_excess_growth |
| 경기 | 678 | 894 | 811.37 | 82.63 | large_base_excess_growth |
| 대구 | 125 | 229 | 149.59 | 79.41 | small_base_excess_growth |
| 강원 | 98 | 133 | 117.28 | 15.72 | moderate_or_stable |
| 제주 | 27 | 48 | 32.31 | 15.69 | fast_growth_from_small_base |

핵심 해석은 유지된다. 서울·경기·대구는 단순히 인구가 많아서 증가한 것이 아니라, 전국 평균 성장률을 적용해도 설명되지 않는 초과증가가 크다.

## 3. 연령 메커니즘: 사건성 자료가 필요한 이유

| age_band | rate_change_2022_2024 | hidden_acute_crisis_index | persistent_accumulation_zmean | refined_mechanism_type |
| --- | --- | --- | --- | --- |
| 40 - 44세 | 10.40 | -2.18 | -1.28 | new_risk_entry |
| 45 - 49세 | 13.00 | 1.66 | -0.34 | hidden_acute_crisis |
| 50 - 54세 | 13.50 | 2.45 | -0.10 | hidden_acute_crisis |
| 55 - 59세 | 11.10 | -0.23 | 0.51 | persistent_accumulation |
| 60 - 64세 | 10.50 | -1.69 | 1.21 | persistent_accumulation |
...
| institution | dataset | unit | target_population | years | research_use |
| --- | --- | --- | --- | --- | --- |
| 근로복지공단/고용정보원 | 고용보험 피보험 자격 상실자 | 성×5세연령×시도/시군구×월 또는 연도×상실사유 | 남성 45-64세 우선, 가능하면 40-64세 | 2015-2025 | 50-54세 숨은 급성 자살위기 직접 검증 |
| 국세청/KOSIS 국세통계 | 폐업자 현황 | 연령×성×지역×연도 | 남성 40-64세 사업자 | 2014-2024 | 공개 대체 사건지표; DT_13301N_9810 우선 |
| 국가데이터처/KOSIS 인구동향조사 | 이혼율/이혼건수 | 시도×성×연령×연도 | 남성 40-64세 | 2014-2025 | 관계해체 사건성 위험 대체지표 |
| 국민건강보험공단 | 건강보험료 체납/장기체납 | 성×연령×지역×연도 | 남성 45-64세 또는 40-64세 | 2015-2025 | 소득단절·건강보장 취약 직접 지표 |
| 신용회복위원회/한국신용정보원 | 채무조정·연체·개인회생/파산 관련 집계 | 성×연령×지역×연도 | 남성 45-64세 또는 40-64세 | 2015-2025 | 부채 충격과 급성 자살위기 경로 검증 |
| 중앙응급의료센터/NEDIS 또는 질병관리청 손상감시 | 응급실 내원 자해·자살시도 | 성×연령×지역×연도 | 남성 40-64세 | 2015-2025 | 자살 사망 이전의 비치명 급성위기 지표 |
| 보건복지부/지자체 | 고독사 실태조사 세부자료 | 성×연령×지역×연도×발견소요시간×주거형태 | 남성 40-69세, 40-64세 별도 | 2020-2024 | 자살과 구분되는 발견지연/돌봄공백 메커니즘 검증 |
